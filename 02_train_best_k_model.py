...
# Add the arguments
parser.add_argument("-n", "--number", type=int, default=7, help="Number of substrate class  (default: 7)")
...
range_start = args.numberstart
range_end = range_start+1
model = [args.model]  # Ensure the model is always a list
